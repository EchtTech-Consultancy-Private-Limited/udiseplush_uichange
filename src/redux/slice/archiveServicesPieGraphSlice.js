...
import { fetchArchiveServicesPieGraphSchoolData,updateMergeDataToActualData } from "../thunks/archiveServicesThunk";

const archiveServicesPieGraphSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchArchiveServicesPieGraphSchoolData.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(fetchArchiveServicesPieGraphSchoolData.fulfilled, (state, action) => {
        state.isLoading = false;
        state.data = action.payload;
      })
      .addCase(fetchArchiveServicesPieGraphSchoolData.rejected, (state, action) => {
        state.isLoading = false;
        state.isError = true;
      })
...
export default archiveServicesPieGraphSlice.reducer;